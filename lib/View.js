...
function render(model, ns, ctx, renderHash) {
  ...
  if (renderHash) {
    ...
    if (localStorage) {
      var mismatchId = model.id();
      localStorage['mismatch-' + mismatchId + '-bodyHtml'] = bodyHtml;
      localStorage['mismatch-' + mismatchId + '-renderHash'] = renderHash;
      localStorage['mismatch-' + mismatchId + '-renderHashBrowser'] = md5(bodyHtml);
      console.error('Render mismatch mismatch-' + mismatchId + '-renderHash');
    }
